...
const NAME_QUERY = defineQuery(`*[_type == "results" && category == "Elite Men (6 Laps)" && year == 2026]{
    Name
    }|order(Placement asc)`)
...
const BIB_QUERY = defineQuery(`*[_type == "results" && category == "Elite Men (6 Laps)" && year == 2026]{
    bib
    }|order(Placement asc)`)
...
const LAP1_QUERY = defineQuery(`*[_type == "results" && category == "Elite Men (6 Laps)" && year == 2026]{
    lap_1
    }|order(Placement asc)`)
...
const LAP2_QUERY = defineQuery(`*[_type == "results" && category == "Elite Men (6 Laps)" && year == 2026]{
    lap_2
    }|order(Placement asc)`)
...
const LAP3_QUERY = defineQuery(`*[_type == "results" && category == "Elite Men (6 Laps)" && year == 2026]{
    lap_3
    }|order(Placement asc)`)
...
const LAP4_QUERY = defineQuery(`*[_type == "results" && category == "Elite Men (6 Laps)" && year == 2026]{
    lap_4
    }|order(Placement asc)`)
...
const LAP5_QUERY = defineQuery(`*[_type == "results" && category == "Elite Men (6 Laps)" && year == 2026]{
    lap_5
    }|order(Placement asc)`)
var lap5 = await client.fetch(LAP5_QUERY)
for(let i=0; i<lap5.length; i++){
    lap5[i] = Object.values(lap5[i]);
    lap5[i] = JSON.stringify(lap5[i], null, 5).replace(/[\[\]",]+/g, '');
}

const LAP6_QUERY = defineQuery(`*[_type == "results" && category == "Elite Men (6 Laps)" && year == 2026]{
    lap_6
    }|order(Placement asc)`)
var lap6 = await client.fetch(LAP6_QUERY)
for(let i=0; i<lap6.length; i++){
    lap6[i] = Object.values(lap6[i]);
    lap6[i] = JSON.stringify(lap6[i], null, 5).replace(/[\[\]",]+/g, '');
}

const TOTAL_QUERY = defineQuery(`*[_type == "results" && category == "Elite Men (6 Laps)" && year == 2026]{
    total
    }|order(Placement asc)`)
...
for(let i=0; i<results.length; i++){
    ...
    <td className="center">{lap5[i]}</td><td className="center">{lap6[i]}</td><td className="center">{total[i]}</td></tr>
}
