...
const NAME_QUERY = defineQuery(`*[_type == "results" && category == "U15 Open (2 Laps)" && year == 2026]{
    Name
    }|order(Placement asc)`)
...
const BIB_QUERY = defineQuery(`*[_type == "results" && category == "U15 Open (2 Laps)" && year == 2026]{
    bib
    }|order(Placement asc)`)
...
const LAP1_QUERY = defineQuery(`*[_type == "results" && category == "U15 Open (2 Laps)" && year == 2026]{
    lap_1
    }|order(Placement asc)`)
...
const LAP2_QUERY = defineQuery(`*[_type == "results" && category == "U15 Open (2 Laps)" && year == 2026]{
    lap_2
    }|order(Placement asc)`)
...
const TOTAL_QUERY = defineQuery(`*[_type == "results" && category == "U15 Open (2 Laps)" && year == 2026]{
    total
    }|order(Placement asc)`)
